...
class Dataset:
    def __init__(self, args):
        ...
        # Convert to numpy float32 for subsequent standardization
        ...
        # Training data: standardized x / y
...
for i in range(runi):
    ...
    # Transform back to original y scale
    ...
    wd = stats.wasserstein_distance(
        y_pred_flat,
        np.random.normal(mean_gt, std_gt, k)
    )
