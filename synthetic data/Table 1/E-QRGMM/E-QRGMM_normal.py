...
for i in range(runi):
    ...
    ks,_ = stats.kstest(y_pred_flat, 'norm',args=(a0+a1*x0_1+a2*x0_2+a3*x0_3,r0+r1*x0_1+r2*x0_2+r3*x0_3))
    wd = stats.wasserstein_distance(y_pred_flat, stats.norm.rvs(a0+a1*x0_1+a2*x0_2+a3*x0_3,r0+r1*x0_1+r2*x0_2+r3*x0_3,k))
