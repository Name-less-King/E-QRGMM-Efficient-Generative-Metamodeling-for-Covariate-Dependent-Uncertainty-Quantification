...
# coefficients of halfnormal Scenario 
...
mean_gt = stats.halfnorm.stats(loc, scale, moments='m')
mean_cover_flag = 0


quantile_gt =  stats.halfnorm.ppf(0.8,loc,scale)
...
# You can change the number of runs and bootstrap samples
runi = 100
num_samples = 100
k = 100000
