...
m = 100 # number of quantile levels in QRGMM
taulb = 0.1
tauub = 0.9

quantiles = create_custom_grid(m,taulb,tauub)
...
#You can change the number of runs and bootstrap samples here
runi = 100
num_samples = 100
k = 100000
